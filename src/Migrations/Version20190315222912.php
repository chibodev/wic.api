 ...
 */
final class Version20190315222912 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO recipe (id, uuid , name, prep, cook, created_at)
...
(2,\'fb09d733-be43-4ce3-a1df-e55796746738\', \'Rice and Beans with fried fish\', 10, 240, \'2019-03-14\');');
        $this->addSql('INSERT INTO  direction (id, recipe_id, description)
...
(19, 1, \'Put the chicken in a preheated oven at 200 degrees and allow to grill for 30 minutes\'),
...
');
        $this->addSql('INSERT INTO ingredient (id, recipe_id, description, quantity, unit)
